  ...
  return (
    <main className="flex flex-col p-[24px] h-screen gap-4">
      ...
      <div className="flex flex-grow gap-4 sm:flex-col">
        {/* 좌측 텍스트, 로그인 버튼 */}
        <div className="flex flex-col bg-[#f9fafb] w-2/5 rounded-lg p-[80px] justify-center items-start gap-6 sm:w-full sm:px-6 sm:py-[40px]">
          ...
          <Link
            href="/login"
            className="flex h-[48px] text-white items-center bg-point-color2 p-[24px] rounded-[8px] gap-[20px]"
          >
            Log in
        ...
        {/* 우측 이미지 영역 */}
        <div className="w-3/5 px-[112px] py-[48px] flex items-center justify-center sm:w-full sm:p-6">
          <Image
            ...
            height={760}
            placeholder="blur"
            blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mOcNnfadwAGXALC45GtdQAAAABJRU5ErkJggg=="
            className="sm:hidden"
          />
          <Image
            src="/hero-mobile.png"
